    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        integrated.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                price.setTextColor(getResources().getColor(R.color.tv_Black));
                sales.setTextColor(getResources().getColor(R.color.tv_Black));
                integrated.setTextColor(getResources().getColor(R.color.colorPrimary));
        ...
        price.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                integrated.setTextColor(getResources().getColor(R.color.tv_Black));
                sales.setTextColor(getResources().getColor(R.color.tv_Black));
