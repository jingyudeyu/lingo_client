...
import com.lovegod.newbuy.view.fragment.shopfragments.ShopAllGoodFragment;
import com.lovegod.newbuy.view.fragment.shopfragments.ShopCategoryFragment;
...
//        shop_san.getBackground().setAlpha(180);
    ...
    private void initData() {
     ...
     /*   for (int i = 0; i < mTitles.length; i++) {
        ...
        bundle1.putInt(Commen.SHOPSID,shopdd.getSid());
      ...
      //  mFragments.add(shopHomeFragment);
        mFragments.add(shopAllGoodFragment);
        mFragments.add(shopCategoryFragment);
