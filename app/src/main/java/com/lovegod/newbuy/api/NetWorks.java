...
public class NetWorks extends RetrofitUtils {
    ...
    /*sortApi.................*/
    //根据店铺id查找分类
    public static void getSidCategory(int sid, BaseObserver<List<SortFrist>> categoriesObserver) {
        setSubscribe(sortApi.getSidCategory(sid), categoriesObserver);
    }

    //根据商品名称模糊查询分类
    public static void getNameCategory(String goodsname, BaseObserver<List<SortFrist>> goodnameObserver) {
        setSubscribe(sortApi.getNameCategory(goodsname), goodnameObserver);
    }

    //根据小一类类别查找类别信息
    public static void getsmallCategory(String small, BaseObserver<List<SortFrist>> smallObserver) {
        setSubscribe(sortApi.getsmallCategory(small), smallObserver);
    }

    /*根据店铺id和分类id查找商品*/
    public static void getSidCgidgoods(int sid, int cgid, BaseObserver<List<Commodity>> categorygoodsBaseObserver) {
        setSubscribe(goodsApi.getSidCgidgoods(sid, cgid), categorygoodsBaseObserver);
    }
    /*sortApi..........*/
